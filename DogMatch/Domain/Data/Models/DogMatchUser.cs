...
namespace DogMatch.Domain.Data.Models
{
    public class DogMatchUser : IdentityUser
    {
        public DogMatchUser()
        {
            ...
            DogAlbumImages = new HashSet<DogImages>();
        ...
        public virtual UserImages UserProfileImage { get; set; }
        ...
        public virtual ICollection<DogImages> DogAlbumImages { get; set; }
        public virtual ICollection<UserImages> UserImages { get; set; }
        public virtual ICollection<UserImages> UserImagesCreatedBy { get; set; }
